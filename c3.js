/* @license C3.js v0.4.26 | (c) C3 Team and other contributors | http://c3js.org/ */
...
function AxisInternal(component, params) {
    ...
    internal.tickFormat = function (v) {
        return String(v);
    };
...
c3_axis_internal_fn.generateAxis = function () {
    ...
    axis.tickFormat = function (format) {
        ...
        internal.tickFormat = format || function (v) {
            return String(v);
        };
        return axis;
    };
...
c3_chart_internal_fn.initWithData = function (data) {
    ...
    if ($$.initSubchart && config.subchart_show) {
        $$.initSubchart();
    }
    if ($$.initTooltip) {
        $$.initTooltip();
...
c3_chart_internal_fn.updateTargets = function (targets) {
    ...
    if ($$.updateTargetsForSubchart && $$.config.subchart_show) {
